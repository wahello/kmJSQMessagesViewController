Pod::Spec.new do |s|
	s.name = 'kmJSQMessagesViewController'
	s.version = '7.2.0'
	s.summary = 'An elegant messages UI library for iOS.'
	s.homepage = 'https://github.com/keyeMyria/kmJSQMessagesViewController'
	s.license = 'MIT'
	s.platform = :ios, '7.0'

	s.author = { 'Keye Myria' => 'keye.myria@yahoo.com' }
#	s.social_media_url = 'https://twitter.com/jesse_squires'
	...
	s.source = { :git => 'https://github.com/keyeMyria/kmJSQMessagesViewController.git', :tag => s.version }
